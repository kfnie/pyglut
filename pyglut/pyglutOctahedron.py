...
from polyhedrons_generators import generate_octahedron
...
class Octahedron(object) :
  def __init__(self,side_length,display_mode="lined",lines_color=False,faces_color=False,lines_width=1,display_ls=False) :
    ...
    self.polyhedron=generate_octahedron(side_length)
    self.ls=Localview()
  ...
  def __doc__(self) :
    ...
    print('''
    Generate an octahedron object with position updating, 
    display and settings setters methods.
    
    The display mode set how the octahedron will be display 
    ...
    -> An object from <type 'Color'> in which case the octahedron 
