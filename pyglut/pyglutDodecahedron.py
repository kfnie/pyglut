...
from polyhedrons_generators import generate_dodecahedron
...
class Dodecahedron(object) :
  def __init__(self,side_length,display_mode="lined",lines_color=False,faces_color=False,lines_width=1,display_ls=False) :
    ''' Generate an Dodecahedron object with the given side length settings.
        ...
        faces_color  = An objet <type 'Color'> representing the faces color.
                       ...
                       One item per dodecahedron face. 
    ...
    self.polyhedron=generate_dodecahedron(side_length)
    self.ls=Localview()
  ...
  def __doc__(self) :
    ...
    The display mode set how the dodecahedron will be display 
    ...
    -> An object from <type 'Color'> in which case the dodecahedron 
