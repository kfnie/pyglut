...
from polyhedrons_generators import generate_icosahedron
...
class Icosahedron(object) :
  ...
  def __doc__(self) :
    ...
    print('''
    Generate an icosahedron object with position updating, 
    display and settings setters methods.
    
    The display mode set how the icosahedron will be display 
    ...
    -> An object from <type 'Color'> in which case the icosahedron 
