...
pyglut an pyopengl utilities module with severals 3D programming helper classes and functions utilities.
This module implement low-levels forms generating, utils, datatypes and predefine 3D objects.
...
maintainer="Eddie Bruggemann"
maintainer_email="mrcyberfighter@gmail.com"

platforms=["Linux","Windows"]

license="GPLv3"

# To install the module under Linux use the pip programm :
...
# To install the module pyglut under Windows use the pip module:
